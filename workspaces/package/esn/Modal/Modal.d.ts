...
import { BoxProps, TypeColor } from '../Box/Box';
import { TypeAnimation } from '../Appear/Appear';
import './Modal.css';
export declare const ModalContext: React.Context<{
    onClose?: ((event: React.PointerEvent<HTMLElement>) => void) | undefined;
}>;
/**
