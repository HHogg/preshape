...
function SvgPictogramOptions(props) {
  return (
    <svg viewBox="0 0 248 96" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      >
        ...
        >
          <path
            d="M0 76V2a2 2 0 012-2h192a2 2 0 012 2v74h0"
        ...
        <rect
          ...
          rx={1}
        />
        <g id="pictogram-options_svg__Group-Copy" transform="translate(29 23)">
          <path
...
export default SvgPictogramOptions;
